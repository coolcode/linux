...
#	Version: 2.0.38
#	Author: Bruce
#	Blog: https://github.com/coolcode
#=================================================
...
Set_config_method(){
 ...
 ${Green_font_prefix}10.${Font_color_suffix} aes-256-cfb [✔️]
...
Set_config_protocol(){
 ...
 ${Green_font_prefix}4.${Font_color_suffix} auth_aes128_sha1 [✔️]
...
Set_config_obfs(){
 ...
 ${Green_font_prefix}2.${Font_color_suffix} http_simple [✔️]
...
echo -e "  ShadowsocksR 一键管理脚本 ${Red_font_prefix}[v${sh_ver}]${Font_color_suffix}
  ---- Bruce | https://github.com/coolcode ----
